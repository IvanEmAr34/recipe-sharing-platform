        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (
            <>
              <Link
                href="/dashboard"
                className="hidden rounded-full border border-stone-200 px-4 py-2 text-sm font-medium text-stone-600 transition-colors hover:bg-stone-100 hover:text-stone-900 sm:inline-flex"
              >
                Dashboard
              </Link>
              <Link
